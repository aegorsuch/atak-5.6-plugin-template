...
public class HotPursuitTool extends AbstractPluginTool implements Disposable {

    private final static String TAG = "HotPursuitTool";

    public HotPursuitTool(final Context context) {
        super(context,
                context.getString(R.string.app_name),
                context.getString(R.string.app_name),
                context.getResources().getDrawable(R.drawable.ic_launcher),
                "com.atakmap.android.hotpursuit.SHOW_HOT_PURSUIT");

        AtakBroadcast.getInstance().registerReceiver(br,
                new AtakBroadcast.DocumentedIntentFilter(
                        "com.atakmap.android.hotpursuit.plugin.iconcount"));
    ...
    private final BroadcastReceiver br = new BroadcastReceiver() {
        ...
        public void onReceive(Context c, Intent intent) {
            ...
            NavButtonModel mdl = NavButtonManager.getInstance()
                    .getModelByPlugin(HotPursuitTool.this);
            if (mdl != null) {
